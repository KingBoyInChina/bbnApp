...
namespace bbnApp.deskTop.AssistiveTools.Base64
{
    public partial class Base64PageViewModel : BbnPageBase
    {
        ...
        public Base64PageViewModel(ISukiToastManager ToastManager, ISukiDialogManager DialogManager, PageNavigationService nav) : base("AssistiveToolsKeys", "BASE64加解密", MaterialIconKind.Decrement, "bbn-base64", 2)
        {
        ...
        private void DataEncrypt()
        {
            try
            {
                ...
                {
                    Ciphertext = EncodeAndDecode.Base64Encode(Plaintext);
        ...
        private void DataDecrypt()
        {
            try
            {
                ...
                {
                    Ciphertext = EncodeAndDecode.Base64Decode(Plaintext);
                    sukiToastManager.CreateToast()
                        .WithTitle("解密提示")
                        .WithContent("数据解密成功!")
                        .OfType(NotificationType.Success)

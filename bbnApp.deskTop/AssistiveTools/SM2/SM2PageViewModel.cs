...
namespace bbnApp.deskTop.AssistiveTools.SM2
{
    public partial class SM2PageViewModel : BbnPageBase
    {
        ...
        public SM2PageViewModel(ISukiToastManager ToastManager, ISukiDialogManager DialogManager, PageNavigationService nav) : base("AssistiveToolsKeys", "SM2加解密", MaterialIconKind.Decrement, "bbn-guomi", 2)
        {
        ...
        private void DataEncrypt()
        {
            try
            {
                ...
                {
                    Ciphertext = EncodeAndDecode.SM2Encrypt(Plaintext);
        ...
        private void DataDecrypt()
        {
            try
            {
                ...
                {
                    Ciphertext = EncodeAndDecode.SM2Decrypt(Plaintext);
                    sukiToastManager.CreateToast()
                        .WithTitle("解密提示")
                        .WithContent("数据解密成功!")
                        .OfType(NotificationType.Success)

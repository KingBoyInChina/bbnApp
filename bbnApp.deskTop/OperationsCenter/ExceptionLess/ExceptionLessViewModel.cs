...
{
    partial class ExceptionLessViewModel : BbnPageBase
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public ExceptionLessViewModel(ISukiDialogManager DialogManager, PageNavigationService nav, IDialog dialog, IConfiguration configuration) : base("OperationsCenter", "ExceptionLess平台", MaterialIconKind.Warning, "", 13)
        {
        ...
        public void Init(WebView webview, UserControl NowControl)
        {
            ...
            ObjSetting = JObject.Parse(Obj["exceptionless"].ToString());

...
namespace bbnApp.deskTop.PlatformManagement.Theming;

public partial class ThemingViewModel : BbnPageBase
{
    ...
    public ThemingViewModel() : base("Hidden", "主题设置", MaterialIconKind.PaletteOutline, "bbn-style", 1)
    {
